...
public class ProgressThread extends Thread {
	...
	/**
	 * Number of milliseconds between calls to Reporter.progress(). Should be a
	 * multiple of the sleepInterval.
	 */
	private int reportInterval;

	public static final String MAX_PROGRESS_PERIOD_KEY = "cifs2hdfs.mapred.auto.progress.max";
	public static final String SLEEP_INTERVAL_KEY = "cifs2hdfs.mapred.auto.progress.sleep";
	public static final String REPORT_INTERVAL_KEY = "cifs2hdfs.mapred.auto.progress.report";
