 ...
 * </ul>
 */
public class Cifs2HDFSParser extends GnuParser {

	public static final Log LOG = LogFactory.getLog(Cifs2HDFSParser.class.getName());
	...
	static {
		try {
			...
			LOG.error("Could not load required method of Parser: " + StringUtils.stringifyException(nsme));
	...
	/**
	 * Util.stripLeadingAndTrailingQuotes() will strip a '&quot;' character from
	 * either or both sides of a string. We only strip the matched pair.
	 */
